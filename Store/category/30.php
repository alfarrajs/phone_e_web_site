...
<section class="section py-3">
    <div class="container">
        <div class="section-header d-flex justify-content-between align-items-center mb-4">
            <h2 class="section--title"><span> &#x645;&#x627;&#x64A;&#x643;&#x631;&#x648;&#x641;&#x648;&#x646;&#x627;&#x62A; </span></h2>
        </div>
        <div class="row products-grid infinite-scroll  mobile-card-no-margin  grid-col-4  eq-height">
                   <!-- product start -->
                 <?php
                 include ('../../admin/config.php');
                 $res =mysqli_query($conn,"select * from products,cate where products.cate_id=cate.cat_id and cat_name='microphones'");
                 ?>

...
<section class="section py-3">
    <div class="container">
        <div class="section-header d-flex justify-content-between align-items-center mb-4">
            <h2 class="section--title"><span> &#x62C;&#x644;&#x627;&#x643;&#x633;&#x64A; &#x627;&#x633; 23 &#x627;&#x644;&#x62A;&#x631;&#x627; </span></h2>
        </div>
        <div class="row products-grid infinite-scroll  mobile-card-no-margin  grid-col-4  eq-height">
                 ...
                 $res =mysqli_query($conn,"select * from products,cate where products.cate_id=cate.cat_id and cat_name='Galaxy_s_23_ultra'");
                 ?>

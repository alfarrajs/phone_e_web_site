...
<section class="section py-3">
    <div class="container">
        <div class="section-header d-flex justify-content-between align-items-center mb-4">
            <h2 class="section--title"><span> &#x633;&#x645;&#x627;&#x639;&#x627;&#x62A; &#x633;&#x628;&#x64A;&#x643;&#x631; </span></h2>
        </div>
        <div class="row products-grid infinite-scroll  mobile-card-no-margin  grid-col-4  eq-height">
                 ...
                 $res =mysqli_query($conn,"select * from products,cate where products.cate_id=cate.cat_id and cat_name='speakers_headphones'");
                 ?>
